...
class ProbMaxPolicy(Policy):
    ...
    def sample(self, **kwargs) -> torch.Tensor:
        ...
        #root_belief_action_weights = reference_policy._belief_action_weights[0, 1:]    
        ...
        #best_action = reference_policy.action_values[torch.argmax(root_belief_action_weights)]
